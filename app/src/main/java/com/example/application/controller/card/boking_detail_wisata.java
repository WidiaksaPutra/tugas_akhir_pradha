...
public class boking_detail_wisata extends AppCompatActivity{
    ...
    public void backdetail (View v){
        Intent back = new Intent(boking_detail_wisata.this, boking.class);
        startActivity(back);
    }
    public void map (View v){
        ...
        Intent mapwisata = new Intent(boking_detail_wisata.this, MapsActivity_Detail_Wisata.class);
