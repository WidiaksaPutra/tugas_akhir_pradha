...
public class wisatawanumum_detail_wisata extends AppCompatActivity{
    ...
    public void backdetail (View v){
        Intent back = new Intent(wisatawanumum_detail_wisata.this, wisataumum.class);
        startActivity(back);
    }
    public void map (View v){
        ...
        Intent mapwisata = new Intent(wisatawanumum_detail_wisata.this, MapsActivity_Detail_Wisata.class);
