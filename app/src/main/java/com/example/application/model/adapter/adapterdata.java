...
import com.example.application.controller.card.wisatawanumum_detail_wisata;
...
public class adapterdata extends RecyclerView.Adapter<adapterdata.HolderData> {
    ...
    public adapterdata (Context ctx, List<SelectModel> mList){
        this.ctx = ctx;
        this.mList = mList;
    }
...
//            Harga = (TextView) v.findViewById(R.id.card_harga);
            ...
            detail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent detaill = new Intent(ctx, wisatawanumum_detail_wisata.class);
